...
namespace Michsky.DreamOS
{
    ...
    public class HorizontalSelector : MonoBehaviour
    {
        ...
        void OnEnable()
        {
            ...
            if (items.Count > 0 && useLocalization && !string.IsNullOrEmpty(items[index].localizationKey) && localizedObject.CheckLocalizationStatus()) { label.text = localizedObject.GetKeyOutput(items[index].localizationKey); }
        }
        ...
        public void InitializeSelector()
        {
            ...
            if (saveSelected)
            {
                if (DreamOSDataManager.ContainsJsonKey(dataCategory, saveKey) == true) { defaultIndex = DreamOSDataManager.ReadIntData(dataCategory, saveKey); }
                else { DreamOSDataManager.WriteIntData(dataCategory, saveKey, defaultIndex); }
            }
            ...
            if (enableIcon)
            {
                if (labelIcon != null) { labelIcon.gameObject.SetActive(true); labelIcon.sprite = items[defaultIndex].itemIcon; }
                if (labelIconHelper != null) { labelIconHelper.gameObject.SetActive(true); labelIconHelper.sprite = labelIcon.sprite; }    
            }
        ...
        public void PreviousItem()
        {
            ...
            if (saveSelected) { DreamOSDataManager.WriteIntData(dataCategory, saveKey, index); }
            if (enableIndicator)
            {
        ...
        public void UpdateUI()
        {
            ...
            if (labelIcon != null && enableIcon)
            {
                ...
                labelIconHelper.gameObject.SetActive(true); 
