...
namespace Michsky.DreamOS
{
    ...
    public class HorizontalSelectorEditor : Editor
    {
        ...
        {
            DreamOSEditorHandler.DrawComponentHeader(customSkin, "TopHeader_HorizontalSelector");
            ...
            switch (currentTab)
            {
                ...
                case 1:
                    ...
                    DreamOSEditorHandler.DrawProperty(selectorAnimator, customSkin, "Animator");
                    ...
                    DreamOSEditorHandler.DrawProperty(labelIcon, customSkin, "Label Icon");
                    DreamOSEditorHandler.DrawProperty(labelIconHelper, customSkin, "Label Icon Helper");
                    ...
                    DreamOSEditorHandler.DrawProperty(contentLayout, customSkin, "Content Layout");
                    DreamOSEditorHandler.DrawProperty(contentLayoutHelper, customSkin, "Content Layout Helper");
                    break;

                case 2:
                    DreamOSEditorHandler.DrawHeader(customSkin, "Header_Customization", 6);     
                    
                    GUILayout.BeginVertical(EditorStyles.helpBox);
                    GUILayout.Space(-3);
                    enableIndicator.boolValue = DreamOSEditorHandler.DrawTogglePlain(enableIndicator.boolValue, customSkin, "Enable Indicators");
                    GUILayout.Space(3);
                    GUILayout.BeginHorizontal();
                    ...
                    if (enableIcon.boolValue == true && hsTarget.labelIcon == null) { EditorGUILayout.HelpBox("'Enable Icon' is enabled but 'Label Icon' is missing.", MessageType.Error); }
                    else { hsTarget.UpdateEditorUI(); }

                    GUILayout.EndVertical();

                    if (enableIcon.boolValue == false) { GUI.enabled = false; }
                    DreamOSEditorHandler.DrawProperty(iconScale, customSkin, "Icon Scale");
                    ...
                    invokeOnAwake.boolValue = DreamOSEditorHandler.DrawToggle(invokeOnAwake.boolValue, customSkin, "Invoke On Awake", "Process events on awake.");
                    ...
                    GUILayout.BeginVertical(EditorStyles.helpBox);
                    GUILayout.Space(-3);
                    saveSelected.boolValue = DreamOSEditorHandler.DrawTogglePlain(saveSelected.boolValue, customSkin, "Save Selected");
                    GUILayout.Space(3);
