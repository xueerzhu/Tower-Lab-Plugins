...
namespace Michsky.DreamOS
{
    ...
    public class SliderManagerEditor : Editor
    {
        ...
        {
            DreamOSEditorHandler.DrawComponentHeader(customSkin, "TopHeader_Slider");
            ...
            switch (currentTab)
            {
                ...
                case 1:
                    ...
                    DreamOSEditorHandler.DrawProperty(sliderObject, customSkin, "Slider Source");
                    if (showValue.boolValue == true) { DreamOSEditorHandler.DrawProperty(valueText, customSkin, "Label Text"); }
                ...
                case 2:
                    ...
                    showValue.boolValue = DreamOSEditorHandler.DrawToggle(showValue.boolValue, customSkin, "Show Label");
                    showPopupValue.boolValue = DreamOSEditorHandler.DrawToggle(showPopupValue.boolValue, customSkin, "Show Popup Label");
