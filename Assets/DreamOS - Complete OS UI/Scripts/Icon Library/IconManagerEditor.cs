...
namespace Michsky.DreamOS
{
    ...
    public class IconManagerEditor : Editor
    {
        ...
        {
            DreamOSEditorHandler.DrawComponentHeader(customSkin, "TopHeader_IconManager");
            ...
            switch (currentTab)
            {
                case 0:
                    ...
                    else
                    {
                        ...
                        GUILayout.Box(imTarget.iconLibrary.icons[imTarget.selectedIconIndex].iconPreview, customSkin.FindStyle("IconManagerPreview"));
                    ...
                    GUILayout.Box(imTarget.iconLibrary.searchIcon, customSkin.FindStyle("IconManagerSearch"));
                    ...
                    if (searchText == null || searchText == "")
                    {
                        for (int i = 0; i < imTarget.iconLibrary.icons.Count; i++)
                        {
                            ...
                            GUILayout.Box(imTarget.iconLibrary.icons[i].iconPreview, customSkin.FindStyle("IconManagerItem"));
                ...
                case 1:
                    GUILayout.Space(6);
                    GUILayout.Box(new GUIContent(""), customSkin.FindStyle("Header_Settings"));
