...
namespace Michsky.DreamOS
{
    ...
    public class LocalizedObjectEditor : Editor
    {
        ...
        private void OnEnable()
        {
            ...
            if (EditorGUIUtility.isProSkin) { customSkin = DreamOSEditorHandler.GetDarkEditor(customSkin); }
            else { customSkin = DreamOSEditorHandler.GetLightEditor(customSkin); }

            if (loTarget.localizationSettings == null
                && Resources.Load<UIManager>("UI Manager/DreamOS UI Manager") != null
                && Resources.Load<UIManager>("UI Manager/DreamOS UI Manager").localizationSettings != null)
            {
                loTarget.localizationSettings = Resources.Load<UIManager>("UI Manager/DreamOS UI Manager").localizationSettings;
            }
        ...
        public override void OnInspectorGUI()
        {
            ...
            switch (currentTab)
            {
                case 0:
                    ...
                    DreamOSEditorHandler.DrawProperty(localizationSettings, customSkin, "Loc. Settings");
                    GUI.enabled = true;
                    ...
                    {
                        DreamOSEditorHandler.DrawProperty(audioObj, customSkin, "Audio Source");
                    }

                    else if (loTarget.objectType == LocalizedObject.ObjectType.Image)
                    {
                        DreamOSEditorHandler.DrawProperty(imageObj, customSkin, "Image Object");
                    }
